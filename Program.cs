...
namespace ConsoleApp9
{
    class Program
    {
        ...
        static List<worker> workers = new List<worker>()
            {
                new worker(1, "Alexandrov", 3),
                new worker(2, "Alexeev   ", 2),
                new worker(3, "Akinfeev  ", 2),
                new worker(4, "Ivanov    ", 3),
                new worker(5, "Petrov    ", 3),
                new worker(6, "Vodka     ", 1),
                new worker(7, "Andreev   ", 1),
                new worker(8, "Ushakov   ", 1),
                new worker(9, "Lapochkin ", 3)
            };
